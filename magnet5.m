...
m2 = [0, 10, 0];   % Magnetic moment vector of the second dipole (same orientation)
...
B_at_1_due_to_2 = [Bx2(13,13,7), By2(13,13,7), Bz2(13,13,7)]; % Field at 1 due to 2
B_at_1_due_to_3 = [Bx3(13,13,7), By3(13,13,7), Bz3(13,13,7)]; % Field at 1 due to 3
B_at_1_due_to_4 = [Bx4(13,13,7), By4(13,13,7), Bz4(13,13,7)]; % Field at 1 due to 4
B_at_1_due_to_5 = [Bx5(13,13,7), By5(13,13,7), Bz5(13,13,7)]; % Field at 1 due to 5
...
T1_2 = f_getTorque(Bx2,By2,Bz2,13,13,7,m1);
T1_3 = f_getTorque(Bx3,By3,Bz3,13,13,7,m1);
T1_4 = f_getTorque(Bx4,By4,Bz4,13,13,7,m1);
T1_5 = f_getTorque(Bx5,By5,Bz5,13,13,7,m1);
...
B_at_2_due_to_1 = [Bx1(13,13,10), By1(13,13,10), Bz1(13,13,10)]; % Field at 2 due to 1
B_at_2_due_to_3 = [Bx3(13,13,10), By3(13,13,10), Bz3(13,13,10)]; % Field at 2 due to 3
B_at_2_due_to_4 = [Bx4(13,13,10), By4(13,13,10), Bz4(13,13,10)]; % Field at 2 due to 4
B_at_2_due_to_5 = [Bx5(13,13,10), By5(13,13,10), Bz5(13,13,10)]; % Field at 2 due to 5
...
% Calculate Torques
T2_1 = f_getTorque(Bx1,By1,Bz1,13,13,10,m2);
T2_3 = f_getTorque(Bx3,By3,Bz3,13,13,10,m2);
T2_4 = f_getTorque(Bx4,By4,Bz4,13,13,10,m2);
T2_5 = f_getTorque(Bx5,By5,Bz5,13,13,10,m2);
...
B_at_3_due_to_1 = [Bx1(13,13,13), By1(13,13,13), Bz1(13,13,13)]; % Field at 3 due to 1
B_at_3_due_to_2 = [Bx2(13,13,13), By2(13,13,13), Bz2(13,13,13)]; % Field at 3 due to 2
B_at_3_due_to_4 = [Bx4(13,13,13), By4(13,13,13), Bz4(13,13,13)]; % Field at 3 due to 4
B_at_3_due_to_5 = [Bx5(13,13,13), By5(13,13,13), Bz5(13,13,13)]; % Field at 3 due to 5
...
% Calculate Torques
T3_1 = f_getTorque(Bx1,By1,Bz1,13,13,13,m3);
T3_2 = f_getTorque(Bx2,By2,Bz2,13,13,13,m3);
T3_4 = f_getTorque(Bx4,By4,Bz4,13,13,13,m3);
T3_5 = f_getTorque(Bx5,By5,Bz5,13,13,13,m3);
...
B_at_4_due_to_1 = [Bx1(13,13,16), By1(13,13,16), Bz1(13,13,16)]; % Field at 4 due to 1
B_at_4_due_to_2 = [Bx2(13,13,16), By2(13,13,16), Bz2(13,13,16)]; % Field at 4 due to 2
B_at_4_due_to_3 = [Bx3(13,13,16), By3(13,13,16), Bz3(13,13,16)]; % Field at 4 due to 3
B_at_4_due_to_5 = [Bx5(13,13,16), By5(13,13,16), Bz5(13,13,16)]; % Field at 4 due to 5
...
% Calculate Torques
T4_1 = f_getTorque(Bx1,By1,Bz1,13,13,16,m4);
T4_2 = f_getTorque(Bx2,By2,Bz2,13,13,16,m4);
T4_3 = f_getTorque(Bx3,By3,Bz3,13,13,16,m4);
T4_5 = f_getTorque(Bx5,By5,Bz5,13,13,16,m4);
...
B_at_5_due_to_1 = [Bx1(13,13,19), By1(13,13,19), Bz1(13,13,19)]; % Field at 5 due to 1
B_at_5_due_to_2 = [Bx2(13,13,19), By2(13,13,19), Bz2(13,13,19)]; % Field at 5 due to 2
B_at_5_due_to_3 = [Bx3(13,13,19), By3(13,13,19), Bz3(13,13,19)]; % Field at 5 due to 3
B_at_5_due_to_4 = [Bx4(13,13,19), By4(13,13,19), Bz4(13,13,19)]; % Field at 5 due to 4
...
% Calculate Torques
T5_1 = f_getTorque(Bx1,By1,Bz1,13,13,19,m5);
T5_2 = f_getTorque(Bx2,By2,Bz2,13,13,19,m5);
T5_3 = f_getTorque(Bx3,By3,Bz3,13,13,19,m5);
T5_4 = f_getTorque(Bx4,By4,Bz4,13,13,19,m5);
...
quiver3(x, y, z, Bx_total, By_total, Bz_total);
hold on;
quiver3(0, 0, 0, torque1(1), 0, 0, 'Color', 'r'); % X-component
quiver3(0, 0, 0, 0, torque1(2), 0, 'Color', 'r'); % Y-component
quiver3(0, 0, 0, 0, 0, torque1(3), 'Color', 'r'); % Z-component
quiver3(0, 0, 0.15, torque2(1), 0, 0, 'Color', 'r'); % X-component
quiver3(0, 0, 0.15, 0, torque2(2), 0, 'Color', 'r'); % Y-component
quiver3(0, 0, 0.15, 0, 0, torque2(3), 'Color', 'r'); % Z-component
quiver3(0, 0, 0.3, torque3(1), 0, 0, 'Color', 'r'); % X-component
quiver3(0, 0, 0.3, 0, torque3(2), 0, 'Color', 'r'); % Y-component
quiver3(0, 0, 0.3, 0, 0, torque3(3), 'Color', 'r'); % Z-component
quiver3(0, 0, 0.45, torque4(1), 0, 0, 'Color', 'r'); % X-component
quiver3(0, 0, 0.45, 0, torque4(2), 0, 'Color', 'r'); % Y-component
quiver3(0, 0, 0.45, 0, 0, torque4(3), 'Color', 'r'); % Z-component
quiver3(0, 0, 0.6, torque5(1), 0, 0, 'Color', 'r'); % X-component
quiver3(0, 0, 0.6, 0, torque5(2), 0, 'Color', 'r'); % Y-component
quiver3(0, 0, 0.6, 0, 0, torque5(3), 'Color', 'r'); % Z-component
hold off;
axis equal;
xlabel('X-axis');
ylabel('Y-axis');
